<ScheduleProgram program_last_label_num="108" program_last_temp_num="129" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="108" last_temp_num="143" instruction_count="69">
        ...
        <Instruction index="25" kind="I_OPER" assem="str `s0, [`s1]">
            ...
            <Src>
                <Temp index="0" num="10400" name="t10400"/>
                <Temp index="1" num="12100" name="t12100"/>
            </Src>
            <Jumps/>
        </Instruction>

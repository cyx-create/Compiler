...
Code for blocking of Quad is given (see `lib/quad/blocking.cc`).

You need to fill in the code in two files: `controlflowinfo.cc` and `dataflowinfo.cc` (**DON"T touch any other files!!**). 

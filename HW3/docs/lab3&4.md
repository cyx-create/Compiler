...
请将实现细节详细地写在实验报告里，主要内容见下文的**Q**。此外，不要忘了 `lab1.md`中要求的报告的其他内容。

- 在HW3中，做的是不带array和class的AST2IRP，报告中只需要包含相关**Q**的回答即可。
- 在HW4中，做的是全部的AST2IRP，需要续写HW3报告的内容，回答以下所有的**Q**。
...
**Hint**: Tiger IR设计请见虎书，Tiger IR+的设计请见上课
...
**Hint**: `Patch_list`和 `Tr_Exp`细节请见虎书和上课

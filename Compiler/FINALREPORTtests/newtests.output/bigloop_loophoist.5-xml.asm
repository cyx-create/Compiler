<ScheduleProgram program_last_label_num="112" program_last_temp_num="114" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="112" last_temp_num="120" instruction_count="52">
        ...
        <Instruction index="8" kind="I_MOVE" assem="movw `d0, #2">
            <Dst>
        ...
        <Instruction index="14" kind="I_OPER" assem="blt `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="29" kind="I_MOVE" assem="movw `d0, #2000">
            <Dst>
        ...
        <Instruction index="35" kind="I_LABEL" assem="L107:">
        ...
        <Instruction index="37" kind="I_OPER" assem="blt `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="38" kind="I_LABEL" assem="L109:">
        ...
        <Instruction index="41" kind="I_OPER" assem="b `j0">
            <Dst/>
            <Src/>
            <Jumps>

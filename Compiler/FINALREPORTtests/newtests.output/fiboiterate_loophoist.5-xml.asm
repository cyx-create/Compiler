<ScheduleProgram program_last_label_num="117" program_last_temp_num="115" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="117" last_temp_num="120" instruction_count="64">

<ScheduleProgram program_last_label_num="145" program_last_temp_num="149" function_count="2">
    <Function index="0" name="__$main__^main" last_label_num="145" last_temp_num="176" instruction_count="151">
    ...
    <Function index="1" name="p^p" last_label_num="101" last_temp_num="105" instruction_count="14">

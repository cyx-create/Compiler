<ScheduleProgram program_last_label_num="118" program_last_temp_num="141" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="118" last_temp_num="153" instruction_count="99">
        ...
        <Instruction index="40" kind="I_OPER" assem="bl malloc">
            <Dst>
                <Temp index="0" num="0" name="t0"/>
                <Temp index="1" num="14" name="t14"/>
            </Dst>
        ...
        <Instruction index="41" kind="I_MOVE" assem="mov `d0, r0">
            <Dst>
        ...
        <Instruction index="42" kind="I_OPER" assem="str `s0, [`s1]">
            <Dst/>
            <Src>
                <Temp index="0" num="10701" name="t10701"/>
        ...
        <Instruction index="46" kind="I_LABEL" assem="L107:">

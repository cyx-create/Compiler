<ScheduleProgram program_last_label_num="113" program_last_temp_num="114" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="113" last_temp_num="120" instruction_count="64">
        ...
        <Instruction index="10" kind="I_MOVE" assem="movw `d0, #2">
            <Dst>
        ...
        <Instruction index="12" kind="I_MOVE" assem="movw `d0, #2000">
            <Dst>

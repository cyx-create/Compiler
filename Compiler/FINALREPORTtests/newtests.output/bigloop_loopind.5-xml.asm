<ScheduleProgram program_last_label_num="112" program_last_temp_num="114" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="112" last_temp_num="120" instruction_count="64">
        ...
        <Instruction index="5" kind="I_MOVE" assem="movw `d0, #3000">
            <Dst>
        ...
        <Instruction index="9" kind="I_MOVE" assem="movw `d0, #2000">
            <Dst>
        ...
        <Instruction index="10" kind="I_OPER" assem="mul `d0, `s0, `s1">
            <Dst>
                <Temp index="0" num="10903" name="t10903"/>
            </Dst>
            <Src>
                <Temp index="0" num="10905" name="t10905"/>
        ...
        <Instruction index="11" kind="I_MOVE" assem="movw `d0, #3">
            <Dst>
        ...
        <Instruction index="21" kind="I_OPER" assem="blt `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="22" kind="I_LABEL" assem="L104:">
        ...
        <Instruction index="28" kind="I_MOVE" assem="movw `d0, #0">
            <Dst>
        ...
        <Instruction index="34" kind="I_LABEL" assem="L103:">
        ...
        <Instruction index="37" kind="I_OPER" assem="add `d0, `s0, #1">
            <Dst>
                <Temp index="0" num="11005" name="t11005"/>
            </Dst>
            <Src>
                <Temp index="0" num="10301" name="t10301"/>
            </Src>
        ...
        <Instruction index="42" kind="I_LABEL" assem="L107:">
        ...
        <Instruction index="43" kind="I_OPER" assem="cmp `s0, `s1">
            ...
            <Src>
                <Temp index="0" num="10302" name="t10302"/>
                <Temp index="1" num="10902" name="t10902"/>
            </Src>
            <Jumps/>
        </Instruction>
        <Instruction index="44" kind="I_OPER" assem="blt `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="45" kind="I_LABEL" assem="L109:">
            <Label num="109" name="L109"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="46" kind="I_OPER" assem="add `d0, `s0, #2000">
            <Dst>
        ...
        <Instruction index="47" kind="I_OPER" assem="add `d0, `s0, #3">
            <Dst>
        ...
        <Instruction index="52" kind="I_OPER" assem="b `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="53" kind="I_LABEL" assem="L108:">
            <Label num="108" name="L108"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="54" kind="I_OPER" assem="add `d0, `s0, #1">
            <Dst>
        ...
        <Instruction index="55" kind="I_OPER" assem="add `d0, `s0, `s1">
            ...
            <Src>
                <Temp index="0" num="10003" name="t10003"/>
                <Temp index="1" num="11002" name="t11002"/>
            </Src>
            <Jumps/>
        </Instruction>
        ...
        <Instruction index="57" kind="I_MOVE" assem="movw `d0, #17">
            <Dst>

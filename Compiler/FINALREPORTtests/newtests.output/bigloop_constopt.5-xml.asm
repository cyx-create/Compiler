<ScheduleProgram program_last_label_num="112" program_last_temp_num="119" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="112" last_temp_num="125" instruction_count="50">
        ...
        <Instruction index="9" kind="I_MOVE" assem="movw `d0, #6000">
            <Dst>
        ...
        <Instruction index="14" kind="I_OPER" assem="bl putint">
            <Dst>
                <Temp index="0" num="0" name="t0"/>
        ...
        <Instruction index="26" kind="I_MOVE" assem="mov `d0, #0">
            <Dst>
        ...
        <Instruction index="29" kind="I_LABEL" assem="L107:">
            <Label num="107" name="L107"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="30" kind="I_MOVE" assem="movw `d0, #2000">
            <Dst>
        ...
        <Instruction index="33" kind="I_OPER" assem="blt `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="43" kind="I_MOVE" assem="movw `d0, #17">
            <Dst>
        ...
        <Instruction index="44" kind="I_OPER" assem="sdiv `d0, `s0, `s1">
            <Dst>
        ...
        <Instruction index="45" kind="I_OPER" assem="add `d0, `s0, `s1">
            <Dst>
        ...
        <Instruction index="46" kind="I_OPER" assem="add `d0, `s0, `s1">
            <Dst>
        ...
        <Instruction index="49" kind="I_OPER" assem="b `j0">
            <Dst/>
            <Src/>
            <Jumps>

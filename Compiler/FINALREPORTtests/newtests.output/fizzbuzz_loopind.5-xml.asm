<ScheduleProgram program_last_label_num="146" program_last_temp_num="149" function_count="2">
    ...
    <Function index="1" name="__$main__^main" last_label_num="146" last_temp_num="176" instruction_count="151">
        ...
        <Instruction index="30" kind="I_MOVE" assem="movw `d0, #3">
            <Dst>
        ...
        <Instruction index="31" kind="I_OPER" assem="sdiv `d0, `s0, `s1">
            <Dst>
        ...
        <Instruction index="35" kind="I_OPER" assem="beq `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="36" kind="I_LABEL" assem="L120:">

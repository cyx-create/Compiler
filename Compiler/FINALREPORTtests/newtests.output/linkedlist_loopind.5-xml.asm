<ScheduleProgram program_last_label_num="123" program_last_temp_num="136" function_count="4">
    ...
    <Function index="1" name="List^next" last_label_num="108" last_temp_num="106" instruction_count="23">
    ...
    <Function index="3" name="List^init" last_label_num="102" last_temp_num="105" instruction_count="14">

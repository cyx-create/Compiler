<ScheduleProgram program_last_label_num="108" program_last_temp_num="105" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="108" last_temp_num="106" instruction_count="23">
        ...
        <Instruction index="10" kind="I_MOVE" assem="mov `d0, #42">
            <Dst>
        ...
        <Instruction index="20" kind="I_MOVE" assem="mov `d0, #42">
            <Dst>

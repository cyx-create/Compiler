<ScheduleProgram program_last_label_num="102" program_last_temp_num="105" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="102" last_temp_num="107" instruction_count="12">
        ...
        <Instruction index="4" kind="I_MOVE" assem="movw `d0, #10">
            <Dst>
        ...
        <Instruction index="6" kind="I_OPER" assem="sdiv `d0, `s0, `s1">
            <Dst>

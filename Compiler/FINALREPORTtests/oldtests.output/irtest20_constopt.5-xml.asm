<ScheduleProgram program_last_label_num="102" program_last_temp_num="136" function_count="2">
    <Function index="0" name="__$main__^main" last_label_num="102" last_temp_num="137" instruction_count="43">
    ...
    <Function index="1" name="B^f" last_label_num="102" last_temp_num="111" instruction_count="15">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>

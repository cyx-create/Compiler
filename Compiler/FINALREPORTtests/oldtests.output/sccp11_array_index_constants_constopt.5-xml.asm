<ScheduleProgram program_last_label_num="108" program_last_temp_num="125" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="108" last_temp_num="136" instruction_count="50">
        ...
        <Instruction index="25" kind="I_MOVE" assem="movw `d0, #7">
            <Dst>
        ...
        <Instruction index="26" kind="I_OPER" assem="str `s0, [`s1, #12]">
            <Dst/>
            <Src>
                <Temp index="0" num="132" name="t132"/>
        ...
        <Instruction index="33" kind="I_LABEL" assem="L105:">
            <Label num="105" name="L105"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="34" kind="I_OPER" assem="ldr `d0, [`s0, #12]">
            <Dst>
        ...
        <Instruction index="45" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="46" kind="I_MOVE" assem="movw `d0, #65535">
            <Dst>
        ...
        <Instruction index="47" kind="I_MOVE" assem="movt `d0, #65535">
            <Dst>
                <Temp index="0" num="136" name="t136"/>
            </Dst>
            <Src/>

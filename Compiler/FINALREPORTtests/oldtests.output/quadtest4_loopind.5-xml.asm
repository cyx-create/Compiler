<ScheduleProgram program_last_label_num="107" program_last_temp_num="105" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="107" last_temp_num="107" instruction_count="25">
        ...
        <Instruction index="16" kind="I_LABEL" assem="L103:">
        ...
        <Instruction index="19" kind="I_OPER" assem="sub `d0, `s0, #1">
            <Dst>

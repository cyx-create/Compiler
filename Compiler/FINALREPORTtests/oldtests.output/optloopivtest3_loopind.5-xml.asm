<ScheduleProgram program_last_label_num="107" program_last_temp_num="116" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="107" last_temp_num="121" instruction_count="43">
        ...
        <Instruction index="10" kind="I_MOVE" assem="movw `d0, #8">
            <Dst>
        ...
        <Instruction index="12" kind="I_MOVE" assem="movw `d0, #8">
            <Dst>
        ...
        <Instruction index="14" kind="I_OPER" assem="add `d0, `s0, #7">
            <Dst>
        ...
        <Instruction index="18" kind="I_LABEL" assem="L102:">
        ...
        <Instruction index="21" kind="I_OPER" assem="bgt `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="31" kind="I_LABEL" assem="L103:">
            <Label num="103" name="L103"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="32" kind="I_OPER" assem="sub `d0, `s0, `s1">
            <Dst>
        ...
        <Instruction index="35" kind="I_OPER" assem="sub `d0, `s0, `s1">
            <Dst>
                <Temp index="0" num="10206" name="t10206"/>
            </Dst>
            <Src>
                <Temp index="0" num="10204" name="t10204"/>
                <Temp index="1" num="10209" name="t10209"/>
            </Src>
            <Jumps/>
        </Instruction>
        <Instruction index="36" kind="I_MOVE" assem="movw `d0, #32">
            <Dst>

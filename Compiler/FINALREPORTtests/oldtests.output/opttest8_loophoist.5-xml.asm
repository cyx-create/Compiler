<ScheduleProgram program_last_label_num="112" program_last_temp_num="103" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="112" last_temp_num="107" instruction_count="37">
        ...
        <Instruction index="7" kind="I_MOVE" assem="movw `d0, #100">
            <Dst>
        ...
        <Instruction index="8" kind="I_MOVE" assem="movw `d0, #200">
            <Dst>
        ...
        <Instruction index="23" kind="I_LABEL" assem="L103:">
            <Label num="103" name="L103"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="24" kind="I_MOVE" assem="movw `d0, #5">
            <Dst>
        ...
        <Instruction index="27" kind="I_LABEL" assem="L108:">
        ...
        <Instruction index="29" kind="I_LABEL" assem="L109:">
        ...
        <Instruction index="34" kind="I_LABEL" assem="L107:">

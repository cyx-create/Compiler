<ScheduleProgram program_last_label_num="110" program_last_temp_num="105" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="110" last_temp_num="106" instruction_count="12">
        ...
        <Instruction index="4" kind="I_LABEL" assem="L105:">
        ...
        <Instruction index="6" kind="I_MOVE" assem="movw `d0, #3">
            <Dst>

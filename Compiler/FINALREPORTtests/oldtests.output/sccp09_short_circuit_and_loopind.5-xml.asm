<ScheduleProgram program_last_label_num="110" program_last_temp_num="103" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="110" last_temp_num="107" instruction_count="28">
        ...
        <Instruction index="9" kind="I_LABEL" assem="L106:">
            <Label num="106" name="L106"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="10" kind="I_MOVE" assem="mov `d0, #2">
            <Dst>
        ...
        <Instruction index="12" kind="I_LABEL" assem="L107:">
        ...
        <Instruction index="18" kind="I_LABEL" assem="L100:">
        ...
        <Instruction index="20" kind="I_OPER" assem="sdiv `d0, `s0, `s1">
            <Dst>
        ...
        <Instruction index="23" kind="I_OPER" assem="beq `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="25" kind="I_MOVE" assem="mov `d0, #1">
            <Dst>

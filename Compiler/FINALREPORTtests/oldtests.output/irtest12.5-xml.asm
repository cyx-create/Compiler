<ScheduleProgram program_last_label_num="107" program_last_temp_num="121" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="107" last_temp_num="140" instruction_count="67">

<ScheduleProgram program_last_label_num="104" program_last_temp_num="122" function_count="2">
    <Function index="0" name="__$main__^main" last_label_num="104" last_temp_num="135" instruction_count="56">
    ...
    <Function index="1" name="TestClass^test1" last_label_num="101" last_temp_num="104" instruction_count="13">

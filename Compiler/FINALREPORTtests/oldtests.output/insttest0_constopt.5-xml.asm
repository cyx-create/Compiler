<ScheduleProgram program_last_label_num="108" program_last_temp_num="113" function_count="2">
    <Function index="0" name="C^max" last_label_num="108" last_temp_num="105" instruction_count="21">
    ...
    <Function index="1" name="__$main__^main" last_label_num="102" last_temp_num="118" instruction_count="27">

<ScheduleProgram program_last_label_num="104" program_last_temp_num="119" function_count="2">
    <Function index="0" name="__$main__^main" last_label_num="101" last_temp_num="128" instruction_count="40">
    ...
    <Function index="1" name="C^m" last_label_num="104" last_temp_num="117" instruction_count="33">

<ScheduleProgram program_last_label_num="112" program_last_temp_num="113" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="112" last_temp_num="115" instruction_count="40">
        ...
        <Instruction index="7" kind="I_MOVE" assem="mov `d0, #100">
            <Dst>
        ...
        <Instruction index="29" kind="I_OPER" assem="sub `d0, `s0, #1">
            <Dst>
        ...
        <Instruction index="36" kind="I_MOVE" assem="mov `d0, #63">
            <Dst>

<ScheduleProgram program_last_label_num="107" program_last_temp_num="114" function_count="3">
    <Function index="0" name="__$main__^main" last_label_num="107" last_temp_num="120" instruction_count="34">
    ...
    <Function index="1" name="Base^value" last_label_num="102" last_temp_num="103" instruction_count="12">
    ...
    <Function index="2" name="Child^value" last_label_num="102" last_temp_num="103" instruction_count="12">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>

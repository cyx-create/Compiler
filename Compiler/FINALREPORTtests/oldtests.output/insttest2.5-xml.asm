<ScheduleProgram program_last_label_num="109" program_last_temp_num="129" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="109" last_temp_num="143" instruction_count="69">
        ...
        <Instruction index="46" kind="I_MOVE" assem="movw `d0, #0">
            <Dst>
        ...
        <Instruction index="50" kind="I_MOVE" assem="movw `d0, #65535">
            <Dst>
        ...
        <Instruction index="51" kind="I_MOVE" assem="movt `d0, #65535">
            <Dst>
                <Temp index="0" num="143" name="t143"/>
            </Dst>
            <Src/>
        ...
        <Instruction index="64" kind="I_MOVE" assem="movw `d0, #32">
            <Dst>

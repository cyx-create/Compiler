<ScheduleProgram program_last_label_num="110" program_last_temp_num="123" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="110" last_temp_num="136" instruction_count="66">
        ...
        <Instruction index="20" kind="I_OPER" assem="sub `d0, `s0, #1">
            <Dst>
                <Temp index="0" num="11905" name="t11905"/>
            </Dst>
            <Src>
                <Temp index="0" num="10101" name="t10101"/>
            </Src>
        ...
        <Instruction index="22" kind="I_OPER" assem="mul `d0, `s0, `s1">
            <Dst>
                <Temp index="0" num="11906" name="t11906"/>
            </Dst>
            <Src>
                <Temp index="0" num="11905" name="t11905"/>
        ...
        <Instruction index="23" kind="I_OPER" assem="add `d0, `s0, #4">
            <Dst>
                <Temp index="0" num="11903" name="t11903"/>
            </Dst>
            <Src>
                <Temp index="0" num="11906" name="t11906"/>
            </Src>
        ...
        <Instruction index="31" kind="I_MOVE" assem="movw `d0, #10">
            <Dst>
        ...
        <Instruction index="34" kind="I_MOVE" assem="movw `d0, #2">
            <Dst>
        ...
        <Instruction index="40" kind="I_LABEL" assem="L103:">
        ...
        <Instruction index="56" kind="I_OPER" assem="ldr `d0, [`s0, `s1]">
            <Dst>
                <Temp index="0" num="10801" name="t10801"/>
            </Dst>
            <Src>
                <Temp index="0" num="10701" name="t10701"/>
                <Temp index="1" num="11902" name="t11902"/>
            </Src>
            <Jumps/>
        </Instruction>
        <Instruction index="57" kind="I_OPER" assem="sub `d0, `s0, #4">
            <Dst>
        ...
        <Instruction index="65" kind="I_OPER" assem="b `j0">
            <Dst/>
            <Src/>
            <Jumps>

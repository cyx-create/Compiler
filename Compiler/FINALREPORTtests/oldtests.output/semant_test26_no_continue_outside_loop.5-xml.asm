<ScheduleProgram program_last_label_num="107" program_last_temp_num="100" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="107" last_temp_num="103" instruction_count="18">
        ...
        <Instruction index="17" kind="I_OPER" assem="b `j0">
            <Dst/>
            <Src/>
            <Jumps>

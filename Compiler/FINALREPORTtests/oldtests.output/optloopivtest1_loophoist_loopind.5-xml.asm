<ScheduleProgram program_last_label_num="108" program_last_temp_num="111" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="108" last_temp_num="116" instruction_count="35">
        ...
        <Instruction index="6" kind="I_OPER" assem="sub `d0, `s0, #1">
            <Dst>
                <Temp index="0" num="10305" name="t10305"/>
            </Dst>
            <Src>
                <Temp index="0" num="10001" name="t10001"/>
            </Src>
        ...
        <Instruction index="8" kind="I_OPER" assem="mul `d0, `s0, `s1">
            <Dst>
                <Temp index="0" num="10306" name="t10306"/>
            </Dst>
            <Src>
                <Temp index="0" num="10305" name="t10305"/>
        ...
        <Instruction index="9" kind="I_OPER" assem="add `d0, `s0, #2">
            <Dst>
        ...
        <Instruction index="12" kind="I_MOVE" assem="movw `d0, #65534">
            <Dst>
        ...
        <Instruction index="29" kind="I_OPER" assem="sub `d0, `s0, #4">
            <Dst>
        ...
        <Instruction index="30" kind="I_MOVE" assem="movw `d0, #32">
            <Dst>

<ScheduleProgram program_last_label_num="109" program_last_temp_num="106" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="109" last_temp_num="110" instruction_count="31">
        ...
        <Instruction index="19" kind="I_OPER" assem="sub `d0, `s0, `s1">
            <Dst>

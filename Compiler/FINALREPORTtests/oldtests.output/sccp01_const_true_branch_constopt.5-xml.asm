<ScheduleProgram program_last_label_num="107" program_last_temp_num="106" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="107" last_temp_num="107" instruction_count="12">
        ...
        <Instruction index="6" kind="I_MOVE" assem="movw `d0, #25">
            <Dst>

<ScheduleProgram program_last_label_num="112" program_last_temp_num="104" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="112" last_temp_num="106" instruction_count="36">
        ...
        <Instruction index="22" kind="I_OPER" assem="bne `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="25" kind="I_MOVE" assem="mov `d0, #4">
            <Dst>
        ...
        <Instruction index="26" kind="I_OPER" assem="sub `d0, `s0, #1">
            <Dst>

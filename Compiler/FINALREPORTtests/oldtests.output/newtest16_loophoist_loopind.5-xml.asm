<ScheduleProgram program_last_label_num="106" program_last_temp_num="110" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="106" last_temp_num="119" instruction_count="35">
        ...
        <Instruction index="27" kind="I_OPER" assem="str `s0, [`s1, `s2]">
            ...
            <Src>
                ...
                <Temp index="2" num="109010101" name="t109010101"/>
            </Src>
            <Jumps/>
        </Instruction>

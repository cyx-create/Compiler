<ScheduleProgram program_last_label_num="105" program_last_temp_num="113" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="105" last_temp_num="117" instruction_count="27">
        ...
        <Instruction index="22" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="23" kind="I_MOVE" assem="movw `d0, #65535">
            <Dst>
        ...
        <Instruction index="24" kind="I_MOVE" assem="movt `d0, #65535">
            <Dst>
                <Temp index="0" num="117" name="t117"/>
            </Dst>
            <Src/>
        ...
        <Instruction index="26" kind="I_OPER" assem="bl exit">
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>

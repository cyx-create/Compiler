<ScheduleProgram program_last_label_num="112" program_last_temp_num="108" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="112" last_temp_num="111" instruction_count="44">
        ...
        <Instruction index="22" kind="I_MOVE" assem="mov `d0, #10">
            <Dst>
        ...
        <Instruction index="27" kind="I_LABEL" assem="L107:">
        ...
        <Instruction index="31" kind="I_LABEL" assem="L109:">

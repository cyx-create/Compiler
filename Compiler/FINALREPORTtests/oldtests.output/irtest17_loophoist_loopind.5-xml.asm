<ScheduleProgram program_last_label_num="103" program_last_temp_num="119" function_count="4">
    ...
    <Function index="2" name="__$main__^main" last_label_num="103" last_temp_num="127" instruction_count="38">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>
        ...
        <Instruction index="25" kind="I_OPER" assem="ldr `d0, [`s0, #8]">
            <Dst>
    ...
    <Function index="3" name="A^f" last_label_num="103" last_temp_num="102" instruction_count="12">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>

<ScheduleProgram program_last_label_num="107" program_last_temp_num="104" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="107" last_temp_num="107" instruction_count="19">
        ...
        <Instruction index="7" kind="I_OPER" assem="beq `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="10" kind="I_LABEL" assem="L106:">
        ...
        <Instruction index="18" kind="I_OPER" assem="b `j0">
            <Dst/>
            <Src/>
            <Jumps>

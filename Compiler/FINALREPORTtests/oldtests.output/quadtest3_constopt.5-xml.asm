<ScheduleProgram program_last_label_num="102" program_last_temp_num="107" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="102" last_temp_num="110" instruction_count="16">
        ...
        <Instruction index="7" kind="I_MOVE" assem="movw `d0, #10">
            <Dst>

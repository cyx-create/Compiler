<ScheduleProgram program_last_label_num="102" program_last_temp_num="111" function_count="2">
    <Function index="0" name="A^f" last_label_num="102" last_temp_num="106" instruction_count="13">
    ...
    <Function index="1" name="__$main__^main" last_label_num="102" last_temp_num="113" instruction_count="22">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>

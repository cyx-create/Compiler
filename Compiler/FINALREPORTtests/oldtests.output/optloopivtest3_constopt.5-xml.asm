<ScheduleProgram program_last_label_num="107" program_last_temp_num="119" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="107" last_temp_num="123" instruction_count="37">
        ...
        <Instruction index="25" kind="I_OPER" assem="sub `d0, `s0, `s1">
            <Dst>
        ...
        <Instruction index="28" kind="I_OPER" assem="add `d0, `s0, #7">
            <Dst>
        ...
        <Instruction index="31" kind="I_MOVE" assem="movw `d0, #32">
            <Dst>

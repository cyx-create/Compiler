<ScheduleProgram program_last_label_num="102" program_last_temp_num="112" function_count="2">
    <Function index="0" name="A^f" last_label_num="102" last_temp_num="111" instruction_count="16">
        ...
        <Instruction index="5" kind="I_MOVE" assem="movw `d0, #8">
            <Dst>
    ...
    <Function index="1" name="__$main__^main" last_label_num="102" last_temp_num="115" instruction_count="21">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>

<ScheduleProgram program_last_label_num="105" program_last_temp_num="122" function_count="4">
    ...
    <Function index="1" name="__$main__^main" last_label_num="105" last_temp_num="135" instruction_count="56">
        <Instruction index="0" kind="I_LABEL" assem="L103:">
            <Label num="103" name="L103"/>
            <Dst/>
            <Src/>
    ...
    <Function index="2" name="TestClass^test0" last_label_num="102" last_temp_num="113" instruction_count="23">

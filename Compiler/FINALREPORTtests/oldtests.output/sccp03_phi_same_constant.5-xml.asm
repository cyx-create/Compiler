<ScheduleProgram program_last_label_num="106" program_last_temp_num="105" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="106" last_temp_num="106" instruction_count="23">

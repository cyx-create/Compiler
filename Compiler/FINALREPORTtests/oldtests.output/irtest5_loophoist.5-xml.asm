<ScheduleProgram program_last_label_num="110" program_last_temp_num="106" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="110" last_temp_num="110" instruction_count="31">
        ...
        <Instruction index="21" kind="I_OPER" assem="ble `j0">
            <Dst/>
            <Src/>
            <Jumps>

<ScheduleProgram program_last_label_num="111" program_last_temp_num="123" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="111" last_temp_num="136" instruction_count="66">
        ...
        <Instruction index="30" kind="I_OPER" assem="bgt `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="35" kind="I_MOVE" assem="movw `d0, #2">
            <Dst>

<ScheduleProgram program_last_label_num="111" program_last_temp_num="117" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="111" last_temp_num="124" instruction_count="42">
        ...
        <Instruction index="18" kind="I_OPER" assem="ldr `d0, [`s0, #4]">
            <Dst>
        ...
        <Instruction index="22" kind="I_LABEL" assem="L106:">
        ...
        <Instruction index="31" kind="I_MOVE" assem="movw `d0, #1">
            <Dst>
        ...
        <Instruction index="37" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="38" kind="I_MOVE" assem="movw `d0, #65535">
            <Dst>
        ...
        <Instruction index="39" kind="I_MOVE" assem="movt `d0, #65535">
            <Dst>
                <Temp index="0" num="124" name="t124"/>
            </Dst>
            <Src/>
        ...
        <Instruction index="41" kind="I_OPER" assem="bl exit">
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>

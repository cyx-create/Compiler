<ScheduleProgram program_last_label_num="101" program_last_temp_num="103" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="101" last_temp_num="103" instruction_count="12">
        ...
        <Instruction index="4" kind="I_MOVE" assem="mov r0, `s0">
            <Dst>
        ...
        <Instruction index="5" kind="I_OPER" assem="bl getarray">
            <Dst>
                <Temp index="0" num="0" name="t0"/>

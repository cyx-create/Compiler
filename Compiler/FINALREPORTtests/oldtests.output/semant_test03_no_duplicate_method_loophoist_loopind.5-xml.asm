<ScheduleProgram program_last_label_num="103" program_last_temp_num="101" function_count="3">
    <Function index="0" name="A^ff" last_label_num="103" last_temp_num="102" instruction_count="11">
    ...
    <Function index="1" name="__$main__^main" last_label_num="103" last_temp_num="101" instruction_count="10">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>

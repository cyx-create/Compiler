<ScheduleProgram program_last_label_num="107" program_last_temp_num="113" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="107" last_temp_num="118" instruction_count="38">
        ...
        <Instruction index="8" kind="I_OPER" assem="add `d0, `s0, #2">
            <Dst>
        ...
        <Instruction index="31" kind="I_OPER" assem="sub `d0, `s0, #8">
            <Dst>
        ...
        <Instruction index="32" kind="I_MOVE" assem="movw `d0, #32">
            <Dst>

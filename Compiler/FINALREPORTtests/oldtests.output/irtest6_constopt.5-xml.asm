<ScheduleProgram program_last_label_num="112" program_last_temp_num="111" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="112" last_temp_num="112" instruction_count="20">
        ...
        <Instruction index="5" kind="I_LABEL" assem="L104:">
        ...
        <Instruction index="7" kind="I_LABEL" assem="L105:">
        ...
        <Instruction index="8" kind="I_MOVE" assem="mov `d0, `s0">
            <Dst>
                <Temp index="0" num="1030301" name="t1030301"/>
            </Dst>
            <Src>
                <Temp index="0" num="10901" name="t10901"/>
            </Src>

<ScheduleProgram program_last_label_num="102" program_last_temp_num="111" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="102" last_temp_num="115" instruction_count="21">
        ...
        <Instruction index="14" kind="I_OPER" assem="bl putarray">
            <Dst>
                <Temp index="0" num="0" name="t0"/>
                <Temp index="1" num="14" name="t14"/>
            </Dst>

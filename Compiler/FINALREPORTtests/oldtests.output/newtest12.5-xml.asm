<ScheduleProgram program_last_label_num="115" program_last_temp_num="170" function_count="2">
    <Function index="0" name="__$main__^main" last_label_num="115" last_temp_num="204" instruction_count="135">
    ...
    <Function index="1" name="fib^f" last_label_num="110" last_temp_num="120" instruction_count="44">

<ScheduleProgram program_last_label_num="109" program_last_temp_num="111" function_count="2">
    <Function index="0" name="__$main__^main" last_label_num="103" last_temp_num="116" instruction_count="27">
        ...
        <Instruction index="8" kind="I_OPER" assem="ldr `d0, =C^max">
            <Dst>
        ...
        <Instruction index="13" kind="I_MOVE" assem="movw `d0, #200">
            <Dst>
        ...
        <Instruction index="15" kind="I_MOVE" assem="mov r1, `s0">
            <Dst>
        ...
        <Instruction index="16" kind="I_MOVE" assem="mov r2, `s0">
            <Dst>
        ...
        <Instruction index="17" kind="I_OPER" assem="blx `s0">
            <Dst>
                <Temp index="0" num="0" name="t0"/>
                <Temp index="1" num="14" name="t14"/>
            </Dst>
        ...
        <Instruction index="18" kind="I_MOVE" assem="mov `d0, r0">
            <Dst>
    ...
    <Function index="1" name="C^max" last_label_num="109" last_temp_num="103" instruction_count="21">

<ScheduleProgram program_last_label_num="112" program_last_temp_num="108" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="112" last_temp_num="111" instruction_count="46">
        ...
        <Instruction index="26" kind="I_OPER" assem="add `d0, `s0, #4">
            <Dst>
        ...
        <Instruction index="27" kind="I_OPER" assem="add `d0, `s0, #6">
            <Dst>
        ...
        <Instruction index="40" kind="I_OPER" assem="b `j0">
            <Dst/>
            <Src/>
            <Jumps>

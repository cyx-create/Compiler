<ScheduleProgram program_last_label_num="106" program_last_temp_num="111" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="106" last_temp_num="120" instruction_count="36">
        ...
        <Instruction index="27" kind="I_MOVE" assem="movw `d0, #1">
            <Dst>
        ...
        <Instruction index="28" kind="I_OPER" assem="str `s0, [`s1, `s2]">
            <Dst/>
            <Src>
                <Temp index="0" num="115" name="t115"/>
                <Temp index="1" num="106010101" name="t106010101"/>
                <Temp index="2" num="110010101" name="t110010101"/>
            </Src>
            <Jumps/>
        </Instruction>

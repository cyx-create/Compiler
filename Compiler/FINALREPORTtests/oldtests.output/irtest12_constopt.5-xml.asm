<ScheduleProgram program_last_label_num="108" program_last_temp_num="123" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="108" last_temp_num="129" instruction_count="23">
        ...
        <Instruction index="19" kind="I_MOVE" assem="movw `d0, #65535">
            <Dst>
        ...
        <Instruction index="20" kind="I_MOVE" assem="movt `d0, #65535">
            <Dst>
                <Temp index="0" num="129" name="t129"/>
            </Dst>
            <Src/>
        ...
        <Instruction index="22" kind="I_OPER" assem="bl exit">
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>

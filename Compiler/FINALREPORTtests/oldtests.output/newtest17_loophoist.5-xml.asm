<ScheduleProgram program_last_label_num="105" program_last_temp_num="111" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="105" last_temp_num="120" instruction_count="36">
        ...
        <Instruction index="28" kind="I_OPER" assem="str `s0, [`s1, `s2]">
            ...
            <Src>
                ...
                <Temp index="2" num="1100101" name="t1100101"/>
            </Src>
            <Jumps/>
        </Instruction>

<ScheduleProgram program_last_label_num="109" program_last_temp_num="147" function_count="2">
    <Function index="0" name="__$main__^main" last_label_num="109" last_temp_num="169" instruction_count="101">
    ...
    <Function index="1" name="C^m" last_label_num="107" last_temp_num="107" instruction_count="23">

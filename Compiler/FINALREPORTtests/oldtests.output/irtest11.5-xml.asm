<ScheduleProgram program_last_label_num="104" program_last_temp_num="109" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="104" last_temp_num="116" instruction_count="33">
        ...
        <Instruction index="25" kind="I_OPER" assem="str `s0, [`s1, `s2]">
            ...
            <Src>
                ...
                <Temp index="2" num="10801" name="t10801"/>
            </Src>
            <Jumps/>
        </Instruction>

<ScheduleProgram program_last_label_num="112" program_last_temp_num="108" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="112" last_temp_num="111" instruction_count="45">
        ...
        <Instruction index="7" kind="I_MOVE" assem="mov `d0, #10">
            <Dst>
        ...
        <Instruction index="8" kind="I_OPER" assem="bl getint">
            <Dst>
        ...
        <Instruction index="12" kind="I_MOVE" assem="movw `d0, #3">
            <Dst>

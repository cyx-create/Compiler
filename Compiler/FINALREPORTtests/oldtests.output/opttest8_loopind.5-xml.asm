<ScheduleProgram program_last_label_num="112" program_last_temp_num="103" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="112" last_temp_num="107" instruction_count="36">
        ...
        <Instruction index="9" kind="I_MOVE" assem="movw `d0, #10">
            <Dst>
        ...
        <Instruction index="31" kind="I_MOVE" assem="movw `d0, #200">
            <Dst>

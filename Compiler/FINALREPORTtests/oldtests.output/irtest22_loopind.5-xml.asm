<ScheduleProgram program_last_label_num="116" program_last_temp_num="170" function_count="2">
    <Function index="0" name="__$main__^main" last_label_num="116" last_temp_num="204" instruction_count="135">
        ...
        <Instruction index="127" kind="I_MOVE" assem="movw `d0, #0">
            <Dst>
        ...
        <Instruction index="128" kind="I_MOVE" assem="movw `d0, #1">
            <Dst>
        ...
        <Instruction index="129" kind="I_OPER" assem="sub `d0, `s0, `s1">
            <Dst>
    ...
    <Function index="1" name="fib^f" last_label_num="111" last_temp_num="120" instruction_count="44">

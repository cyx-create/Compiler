<ScheduleProgram program_last_label_num="105" program_last_temp_num="116" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="105" last_temp_num="122" instruction_count="32">

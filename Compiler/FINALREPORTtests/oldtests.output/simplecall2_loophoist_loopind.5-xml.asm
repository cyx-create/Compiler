<ScheduleProgram program_last_label_num="106" program_last_temp_num="119" function_count="2">
    <Function index="0" name="C^m" last_label_num="106" last_temp_num="117" instruction_count="33">
    ...
    <Function index="1" name="__$main__^main" last_label_num="103" last_temp_num="128" instruction_count="40">

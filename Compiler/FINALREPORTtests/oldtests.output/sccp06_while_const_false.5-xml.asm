<ScheduleProgram program_last_label_num="106" program_last_temp_num="103" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="106" last_temp_num="105" instruction_count="22">
        ...
        <Instruction index="4" kind="I_MOVE" assem="mov `d0, #6">
            <Dst>
        ...
        <Instruction index="18" kind="I_OPER" assem="bl getint">
            <Dst>
                <Temp index="0" num="0" name="t0"/>

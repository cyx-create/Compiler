<ScheduleProgram program_last_label_num="107" program_last_temp_num="104" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="107" last_temp_num="108" instruction_count="25">
        ...
        <Instruction index="5" kind="I_MOVE" assem="movw `d0, #3">
            <Dst>
        ...
        <Instruction index="10" kind="I_OPER" assem="bne `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="12" kind="I_OPER" assem="bl getint">
            <Dst>

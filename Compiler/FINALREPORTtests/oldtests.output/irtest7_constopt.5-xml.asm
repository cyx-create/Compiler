<ScheduleProgram program_last_label_num="110" program_last_temp_num="109" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="110" last_temp_num="109" instruction_count="15">
        ...
        <Instruction index="8" kind="I_LABEL" assem="L106:">
            <Label num="106" name="L106"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="9" kind="I_OPER" assem="add `d0, `s0, #0">
            <Dst>

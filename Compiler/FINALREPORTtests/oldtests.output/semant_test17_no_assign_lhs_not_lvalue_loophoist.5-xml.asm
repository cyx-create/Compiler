<ScheduleProgram program_last_label_num="105" program_last_temp_num="114" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="105" last_temp_num="124" instruction_count="42">
        ...
        <Instruction index="35" kind="I_OPER" assem="str `s0, [`s1, `s2]">
            ...
            <Src>
                ...
                <Temp index="2" num="1130101" name="t1130101"/>
            </Src>
            <Jumps/>
        </Instruction>

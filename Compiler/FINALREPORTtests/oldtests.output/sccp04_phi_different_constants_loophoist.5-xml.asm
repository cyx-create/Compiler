<ScheduleProgram program_last_label_num="107" program_last_temp_num="104" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="107" last_temp_num="105" instruction_count="22">
        ...
        <Instruction index="19" kind="I_MOVE" assem="mov `d0, #1">
            <Dst>
        ...
        <Instruction index="21" kind="I_OPER" assem="b `j0">
            <Dst/>
            <Src/>
            <Jumps>

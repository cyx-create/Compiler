<ScheduleProgram program_last_label_num="113" program_last_temp_num="108" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="113" last_temp_num="111" instruction_count="44">
        ...
        <Instruction index="33" kind="I_LABEL" assem="L109:">
            <Label num="109" name="L109"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="34" kind="I_OPER" assem="sub `d0, `s0, #1">
            <Dst>
        ...
        <Instruction index="40" kind="I_OPER" assem="sub `d0, `s0, #1">
            <Dst>

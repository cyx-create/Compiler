<ScheduleProgram program_last_label_num="113" program_last_temp_num="103" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="113" last_temp_num="107" instruction_count="36">
        ...
        <Instruction index="6" kind="I_MOVE" assem="movw `d0, #100">
            <Dst>
        ...
        <Instruction index="7" kind="I_MOVE" assem="movw `d0, #200">
            <Dst>
        ...
        <Instruction index="23" kind="I_MOVE" assem="movw `d0, #5">
            <Dst>
        ...
        <Instruction index="26" kind="I_LABEL" assem="L108:">
        ...
        <Instruction index="33" kind="I_LABEL" assem="L107:">

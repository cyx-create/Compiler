<ScheduleProgram program_last_label_num="108" program_last_temp_num="113" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="108" last_temp_num="115" instruction_count="30">
        ...
        <Instruction index="18" kind="I_OPER" assem="beq `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="27" kind="I_MOVE" assem="mov `d0, #1">
            <Dst>

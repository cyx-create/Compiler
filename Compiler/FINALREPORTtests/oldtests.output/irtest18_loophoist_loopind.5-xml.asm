<ScheduleProgram program_last_label_num="106" program_last_temp_num="132" function_count="4">
    <Function index="0" name="B^g" last_label_num="103" last_temp_num="105" instruction_count="14">
    ...
    <Function index="1" name="__$main__^main" last_label_num="103" last_temp_num="145" instruction_count="61">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>
        ...
        <Instruction index="38" kind="I_OPER" assem="str `s0, [`s1]">
            ...
            <Src>
                <Temp index="0" num="143" name="t143"/>
                <Temp index="1" num="125010101" name="t125010101"/>
            </Src>
            <Jumps/>
        </Instruction>
    ...
    <Function index="3" name="B^f" last_label_num="106" last_temp_num="130" instruction_count="43">

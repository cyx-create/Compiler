<ScheduleProgram program_last_label_num="116" program_last_temp_num="107" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="116" last_temp_num="113" instruction_count="43">

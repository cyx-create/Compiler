<ScheduleProgram program_last_label_num="110" program_last_temp_num="137" function_count="2">
    <Function index="0" name="__$main__^main" last_label_num="110" last_temp_num="152" instruction_count="76">
    ...
    <Function index="1" name="C^m" last_label_num="102" last_temp_num="105" instruction_count="11">

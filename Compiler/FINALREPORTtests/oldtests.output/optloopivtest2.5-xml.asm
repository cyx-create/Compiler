<ScheduleProgram program_last_label_num="106" program_last_temp_num="113" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="106" last_temp_num="118" instruction_count="35">
        ...
        <Instruction index="17" kind="I_MOVE" assem="movw `d0, #2">
            <Dst>
        ...
        <Instruction index="26" kind="I_OPER" assem="sub `d0, `s0, #2">
            <Dst>
        ...
        <Instruction index="27" kind="I_OPER" assem="add `d0, `s0, #2">
            <Dst>

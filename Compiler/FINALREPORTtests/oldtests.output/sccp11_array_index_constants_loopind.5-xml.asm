<ScheduleProgram program_last_label_num="108" program_last_temp_num="123" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="108" last_temp_num="142" instruction_count="67">
        ...
        <Instruction index="40" kind="I_OPER" assem="str `s0, [`s1, `s2]">
            ...
            <Src>
                ...
                <Temp index="2" num="1170101" name="t1170101"/>
            </Src>
            <Jumps/>
        </Instruction>
        ...
        <Instruction index="61" kind="I_OPER" assem="ldr `d0, [`s0, `s1]">
            ...
            <Src>
                <Temp index="0" num="1090101" name="t1090101"/>
                <Temp index="1" num="1210101" name="t1210101"/>
            </Src>
            <Jumps/>
        </Instruction>

<ScheduleProgram program_last_label_num="114" program_last_temp_num="102" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="114" last_temp_num="105" instruction_count="26">

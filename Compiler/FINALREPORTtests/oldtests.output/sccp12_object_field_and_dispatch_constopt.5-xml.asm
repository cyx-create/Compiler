<ScheduleProgram program_last_label_num="107" program_last_temp_num="116" function_count="3">
    <Function index="0" name="Child^value" last_label_num="102" last_temp_num="105" instruction_count="12">
        ...
        <Instruction index="6" kind="I_OPER" assem="add `d0, `s0, #2">
            <Dst>
    ...
    <Function index="1" name="__$main__^main" last_label_num="107" last_temp_num="119" instruction_count="26">
        ...
        <Instruction index="8" kind="I_OPER" assem="ldr `d0, =Child^value">
            <Dst>
        ...
        <Instruction index="12" kind="I_MOVE" assem="movw `d0, #10">
            <Dst>
        ...
        <Instruction index="18" kind="I_OPER" assem="str `s0, [`s1]">
            <Dst/>
            <Src>
                <Temp index="0" num="1010101" name="t1010101"/>
    ...
    <Function index="2" name="Base^value" last_label_num="102" last_temp_num="105" instruction_count="12">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>

<ScheduleProgram program_last_label_num="112" program_last_temp_num="112" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="112" last_temp_num="115" instruction_count="46">
        ...
        <Instruction index="41" kind="I_OPER" assem="add `d0, `s0, #4">
            <Dst>
        ...
        <Instruction index="42" kind="I_OPER" assem="add `d0, `s0, #6">
            <Dst>

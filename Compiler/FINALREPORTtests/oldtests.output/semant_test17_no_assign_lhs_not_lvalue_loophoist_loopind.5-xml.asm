<ScheduleProgram program_last_label_num="106" program_last_temp_num="114" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="106" last_temp_num="124" instruction_count="42">
        ...
        <Instruction index="35" kind="I_OPER" assem="str `s0, [`s1, `s2]">
            <Dst/>
            <Src>
                <Temp index="0" num="119" name="t119"/>
                <Temp index="1" num="108010101" name="t108010101"/>
                <Temp index="2" num="113010101" name="t113010101"/>
            </Src>
            <Jumps/>
        </Instruction>

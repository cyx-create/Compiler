<ScheduleProgram program_last_label_num="113" program_last_temp_num="104" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="113" last_temp_num="107" instruction_count="33">
        ...
        <Instruction index="4" kind="I_MOVE" assem="movw `d0, #1">
            <Dst>
        ...
        <Instruction index="7" kind="I_OPER" assem="bne `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="8" kind="I_LABEL" assem="L103:">
            <Label num="103" name="L103"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="9" kind="I_OPER" assem="bl getint">
            <Dst>
        ...
        <Instruction index="16" kind="I_LABEL" assem="L108:">
            <Label num="108" name="L108"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="17" kind="I_MOVE" assem="mov `d0, #5">
            <Dst>
        ...
        <Instruction index="26" kind="I_MOVE" assem="mov `d0, #4">
            <Dst>

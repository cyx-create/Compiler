<ScheduleProgram program_last_label_num="101" program_last_temp_num="104" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="101" last_temp_num="106" instruction_count="15">
        ...
        <Instruction index="7" kind="I_OPER" assem="add `d0, `s0, #3">
            <Dst>
        ...
        <Instruction index="8" kind="I_OPER" assem="add `d0, `s0, #4">
            <Dst>
        ...
        <Instruction index="9" kind="I_OPER" assem="add `d0, `s0, #5">
            <Dst>

<ScheduleProgram program_last_label_num="116" program_last_temp_num="115" function_count="2">
    <Function index="0" name="C^m" last_label_num="106" last_temp_num="104" instruction_count="25">
    ...
    <Function index="1" name="__$main__^main" last_label_num="116" last_temp_num="122" instruction_count="67">

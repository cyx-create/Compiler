<ScheduleProgram program_last_label_num="105" program_last_temp_num="122" function_count="2">
    <Function index="0" name="TestClass^test1" last_label_num="102" last_temp_num="104" instruction_count="13">

<ScheduleProgram program_last_label_num="103" program_last_temp_num="12200" function_count="4">
    <Function index="0" name="__$main__^main" last_label_num="100" last_temp_num="127" instruction_count="47">
    ...
    <Function index="2" name="B^f" last_label_num="103" last_temp_num="123" instruction_count="44">

<ScheduleProgram program_last_label_num="103" program_last_temp_num="11000" function_count="2">
    <Function index="0" name="__$main__^main" last_label_num="100" last_temp_num="125" instruction_count="40">
    ...
    <Function index="1" name="C^m" last_label_num="103" last_temp_num="112" instruction_count="25">

<ScheduleProgram program_last_label_num="106" program_last_temp_num="10700" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="106" last_temp_num="126" instruction_count="23">
        ...
        <Instruction index="19" kind="I_OPER" assem="movw `d0, #65535">
            <Dst>
        ...
        <Instruction index="20" kind="I_OPER" assem="movt `d0, #65535">
            <Dst>
                <Temp index="0" num="127" name="t127"/>
            </Dst>
            <Src/>

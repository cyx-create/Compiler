<ScheduleProgram program_last_label_num="110" program_last_temp_num="10100" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="110" last_temp_num="107" instruction_count="31">
        ...
        <Instruction index="11" kind="I_OPER" assem="movw `d0, #100">
            <Dst>
        ...
        <Instruction index="26" kind="I_OPER" assem="bne `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="30" kind="I_OPER" assem="b `j0">
            <Dst/>
            <Src/>
            <Jumps>

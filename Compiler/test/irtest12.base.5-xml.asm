<ScheduleProgram program_last_label_num="100110" program_last_temp_num="11800" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="106" last_temp_num="129" instruction_count="74">
        ...
        <Instruction index="18" kind="I_OPER" assem="sub `d0, `s0, `s1">
            <Dst>
        ...
        <Instruction index="25" kind="I_OPER" assem="mov `d0, `s0">
            <Dst>
        ...
        <Instruction index="26" kind="I_LABEL" assem="L100106:">
            <Label num="100106" name="L100106"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="27" kind="I_OPER" assem="movw `d0, #65535">
            <Dst>
        ...
        <Instruction index="28" kind="I_OPER" assem="movt `d0, #65535">
            <Dst>
                <Temp index="0" num="131" name="t131"/>
            </Dst>
            <Src/>
        ...
        <Instruction index="32" kind="I_OPER" assem="mov `d0, `s0">
            <Dst>
                <Temp index="0" num="10101" name="t10101"/>
            </Dst>
            <Src>
        ...
        <Instruction index="33" kind="I_LABEL" assem="L100107:">
        ...
        <Instruction index="36" kind="I_LABEL" assem="L102:">
        ...
        <Instruction index="38" kind="I_LABEL" assem="L100108:">
        ...
        <Instruction index="40" kind="I_OPER" assem="movw `d0, #4">
            <Dst>
        ...
        <Instruction index="41" kind="I_OPER" assem="mul `d0, `s0, `s1">
            <Dst>
        ...
        <Instruction index="42" kind="I_OPER" assem="movw `d0, #4">
            <Dst>
        ...
        <Instruction index="43" kind="I_OPER" assem="str `d0, [`s0, `s1]">
            <Dst>
                <Temp index="0" num="128" name="t128"/>
            </Dst>
            <Src>
        ...
        <Instruction index="46" kind="I_OPER" assem="movw `d0, #2">
            <Dst>
        ...
        <Instruction index="47" kind="I_OPER" assem="movw `d0, #0">
            <Dst>
        ...
        <Instruction index="49" kind="I_OPER" assem="bge `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="50" kind="I_LABEL" assem="L103:">
        ...
        <Instruction index="53" kind="I_OPER" assem="movw `d0, #65535">
            <Dst>
        ...
        <Instruction index="54" kind="I_OPER" assem="movt `d0, #65535">
            <Dst>
                <Temp index="0" num="134" name="t134"/>
            </Dst>
            <Src/>
        ...
        <Instruction index="56" kind="I_OPER" assem="bl exit">
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="57" kind="I_LABEL" assem="L104:">
            <Label num="104" name="L104"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="58" kind="I_OPER" assem="mov `d0, `s0">
            <Dst>
                <Temp index="0" num="10103" name="t10103"/>
            </Dst>
            <Src>
        ...
        <Instruction index="59" kind="I_LABEL" assem="L100110:">
            <Label num="100110" name="L100110"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="60" kind="I_OPER" assem="movw `d0, #2">
            <Dst>
        ...
        <Instruction index="64" kind="I_OPER" assem="mov `d0, #3">
            <Dst>
        ...
        <Instruction index="65" kind="I_OPER" assem="movw `d0, #4">
            <Dst>
        ...
        <Instruction index="68" kind="I_OPER" assem="movw `d0, #0">
            <Dst>
        ...
        <Instruction index="70" kind="I_OPER" assem="sub sp, fp, #36">
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="71" kind="I_OPER" assem="add sp, sp, #4">
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="72" kind="I_OPER" assem="pop {r4-r10, fp, lr}">
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="73" kind="I_OPER" assem="bx lr">
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>

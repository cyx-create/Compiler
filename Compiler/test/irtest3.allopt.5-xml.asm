<ScheduleProgram program_last_label_num="100105" program_last_temp_num="10003" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="105" last_temp_num="107" instruction_count="28">
        ...
        <Instruction index="11" kind="I_OPER" assem="bgt `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="22" kind="I_OPER" assem="bl putint">
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="23" kind="I_OPER" assem="movw `d0, #10">
            <Dst>

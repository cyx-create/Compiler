<ScheduleProgram program_last_label_num="100" program_last_temp_num="14400" function_count="3">
    <Function index="0" name="A^f" last_label_num="100" last_temp_num="108" instruction_count="15">
    ...
    <Function index="1" name="B^f" last_label_num="100" last_temp_num="118" instruction_count="23">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>
    ...
    <Function index="2" name="__$main__^main" last_label_num="100" last_temp_num="152" instruction_count="69">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>
        ...
        <Instruction index="9" kind="I_OPER" assem="str `d0, [`s0, #16]">
            <Dst>
                <Temp index="0" num="148" name="t148"/>
            </Dst>
            <Src>
        ...
        <Instruction index="11" kind="I_OPER" assem="movw `d0, #20">
            <Dst>
        ...
        <Instruction index="15" kind="I_OPER" assem="adr `d0, B^f">
            <Dst>
        ...
        <Instruction index="16" kind="I_OPER" assem="str `d0, [`s0, #16]">
            <Dst>
                <Temp index="0" num="150" name="t150"/>
            </Dst>
            <Src>
        ...
        <Instruction index="18" kind="I_OPER" assem="add `d0, `s0, #16">
            <Dst>
        ...
        <Instruction index="20" kind="I_OPER" assem="mov r12, `s0">
            <Dst/>
            <Src>
                <Temp index="0" num="10700" name="t10700"/>
            </Src>
        ...
        <Instruction index="22" kind="I_OPER" assem="blx r12">
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="23" kind="I_OPER" assem="add `d0, `s0, #16">
            <Dst>
        ...
        <Instruction index="35" kind="I_OPER" assem="add `d0, `s0, #8">
            <Dst>
        ...
        <Instruction index="38" kind="I_OPER" assem="add `d0, `s0, #12">
            <Dst>
        ...
        <Instruction index="43" kind="I_OPER" assem="movw `d0, #10">
            <Dst>
        ...
        <Instruction index="51" kind="I_OPER" assem="add `d0, `s0, `s1">
            <Dst>
        ...
        <Instruction index="52" kind="I_OPER" assem="add `d0, `s0, #8">
            <Dst>
        ...
        <Instruction index="55" kind="I_OPER" assem="add `d0, `s0, #12">
            <Dst>
        ...
        <Instruction index="57" kind="I_OPER" assem="add `d0, `s0, `s1">
            <Dst>
        ...
        <Instruction index="60" kind="I_OPER" assem="movw `d0, #10">
            <Dst>
        ...
        <Instruction index="63" kind="I_OPER" assem="movw `d0, #1">
            <Dst>
        ...
        <Instruction index="65" kind="I_OPER" assem="sub sp, fp, #36">
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="66" kind="I_OPER" assem="add sp, sp, #4">
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="67" kind="I_OPER" assem="pop {r4-r10, fp, lr}">
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="68" kind="I_OPER" assem="bx lr">
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>

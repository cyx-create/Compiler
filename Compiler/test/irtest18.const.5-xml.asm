<ScheduleProgram program_last_label_num="103" program_last_temp_num="12200" function_count="4">
    ...
    <Function index="1" name="__$main__^main" last_label_num="100" last_temp_num="129" instruction_count="47">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>
    ...
    <Function index="2" name="B^g" last_label_num="100" last_temp_num="107" instruction_count="16">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>

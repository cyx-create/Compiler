<ScheduleProgram program_last_label_num="105" program_last_temp_num="10304" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="105" last_temp_num="118" instruction_count="38">
        ...
        <Instruction index="21" kind="I_OPER" assem="movw `d0, #2">
            <Dst>
        ...
        <Instruction index="33" kind="I_OPER" assem="sub `d0, `s0, #2">
            <Dst>
        ...
        <Instruction index="34" kind="I_OPER" assem="sub `d0, `s0, #8">
            <Dst>

<ScheduleProgram program_last_label_num="110" program_last_temp_num="10200" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="110" last_temp_num="117" instruction_count="48">
        ...
        <Instruction index="12" kind="I_OPER" assem="mov `d0, #4">
            <Dst>
        ...
        <Instruction index="17" kind="I_OPER" assem="movw `d0, #10">
            <Dst>
        ...
        <Instruction index="26" kind="I_OPER" assem="movw `d0, #3">
            <Dst>
        ...
        <Instruction index="32" kind="I_OPER" assem="movw `d0, #2">
            <Dst>
        ...
        <Instruction index="41" kind="I_OPER" assem="movw `d0, #32">
            <Dst>
        ...
        <Instruction index="44" kind="I_OPER" assem="sub `d0, `s0, #3">
            <Dst>

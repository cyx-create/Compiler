<ScheduleProgram program_last_label_num="100109" program_last_temp_num="10004" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="108" last_temp_num="108" instruction_count="35">
        ...
        <Instruction index="9" kind="I_LABEL" assem="L100108:">
            <Label num="100108" name="L100108"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="10" kind="I_OPER" assem="movw `d0, #0">
            <Dst>
        ...
        <Instruction index="13" kind="I_LABEL" assem="L107:">
        ...
        <Instruction index="23" kind="I_OPER" assem="movw `d0, #65535">
            <Dst>
        ...
        <Instruction index="24" kind="I_OPER" assem="movt `d0, #65535">
            <Dst>
                <Temp index="0" num="110" name="t110"/>
            </Dst>
            <Src/>
        ...
        <Instruction index="30" kind="I_OPER" assem="movw `d0, #10">
            <Dst>

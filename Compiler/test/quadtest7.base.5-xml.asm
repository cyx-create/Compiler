<ScheduleProgram program_last_label_num="100" program_last_temp_num="11800" function_count="3">
    ...
    <Function index="1" name="__$main__^main" last_label_num="100" last_temp_num="125" instruction_count="38">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>
        ...
        <Instruction index="6" kind="I_OPER" assem="movw `d0, #12">
            <Dst>
        ...
        <Instruction index="15" kind="I_OPER" assem="movw `d0, #12">
            <Dst>

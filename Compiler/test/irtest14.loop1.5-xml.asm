<ScheduleProgram program_last_label_num="100" program_last_temp_num="10200" function_count="2">
    <Function index="0" name="__$main__^main" last_label_num="100" last_temp_num="109" instruction_count="20">
        ...
        <Instruction index="5" kind="I_OPER" assem="movw `d0, #8">
            <Dst>
        ...
        <Instruction index="9" kind="I_OPER" assem="adr `d0, A^f">
            <Dst>
        ...
        <Instruction index="10" kind="I_OPER" assem="str `d0, [`s0, #4]">
            <Dst>
                <Temp index="0" num="108" name="t108"/>
            </Dst>
            <Src>
        ...
        <Instruction index="12" kind="I_OPER" assem="movw `d0, #1">
            <Dst>

<ScheduleProgram program_last_label_num="105" program_last_temp_num="10102" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="105" last_temp_num="114" instruction_count="37">
        ...
        <Instruction index="8" kind="I_OPER" assem="sub `d0, `s0, #2">
            <Dst>
        ...
        <Instruction index="12" kind="I_OPER" assem="movw `d0, #65530">
            <Dst>
        ...
        <Instruction index="27" kind="I_OPER" assem="sub `d0, `s0, #1">
            <Dst>
        ...
        <Instruction index="33" kind="I_OPER" assem="sub `d0, `s0, #4">
            <Dst>

<ScheduleProgram program_last_label_num="100" program_last_temp_num="11600" function_count="4">
    <Function index="0" name="B^g" last_label_num="100" last_temp_num="104" instruction_count="11">
    ...
    <Function index="1" name="__$main__^main" last_label_num="100" last_temp_num="125" instruction_count="39">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>
    ...
    <Function index="3" name="A^f" last_label_num="100" last_temp_num="104" instruction_count="11">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>

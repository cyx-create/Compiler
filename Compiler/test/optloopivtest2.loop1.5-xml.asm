<ScheduleProgram program_last_label_num="105" program_last_temp_num="10900" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="105" last_temp_num="116" instruction_count="35">
        ...
        <Instruction index="17" kind="I_OPER" assem="movw `d0, #2">
            <Dst>
        ...
        <Instruction index="30" kind="I_OPER" assem="movw `d0, #32">
            <Dst>

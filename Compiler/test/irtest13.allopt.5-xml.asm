<ScheduleProgram program_last_label_num="103" program_last_temp_num="10700" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="103" last_temp_num="117" instruction_count="31">
        ...
        <Instruction index="20" kind="I_OPER" assem="movw `d0, #0">
            <Dst>

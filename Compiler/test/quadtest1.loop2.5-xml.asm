<ScheduleProgram program_last_label_num="100158" program_last_temp_num="15800" function_count="2">
    ...
    <Function index="1" name="__$main__^main" last_label_num="108" last_temp_num="148" instruction_count="96">
        ...
        <Instruction index="52" kind="I_OPER" assem="movw `d0, #10">
            <Dst>
        ...
        <Instruction index="55" kind="I_OPER" assem="movw `d0, #0">
            <Dst>
        ...
        <Instruction index="62" kind="I_OPER" assem="mov `d0, `s0">
            <Dst>
                <Temp index="0" num="10202" name="t10202"/>
            </Dst>
            <Src>
        ...
        <Instruction index="63" kind="I_LABEL" assem="L100110:">

<ScheduleProgram program_last_label_num="105" program_last_temp_num="11300" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="105" last_temp_num="119" instruction_count="37">
        ...
        <Instruction index="27" kind="I_OPER" assem="mul `d0, `s0, `s1">
            ...
            <Src>
                <Temp index="0" num="117" name="t117"/>
                <Temp index="1" num="10302" name="t10302"/>
            </Src>
            <Jumps/>
        </Instruction>

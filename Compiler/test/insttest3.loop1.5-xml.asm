<ScheduleProgram program_last_label_num="108" program_last_temp_num="13000" function_count="2">
    ...
    <Function index="1" name="__$main__^main" last_label_num="108" last_temp_num="145" instruction_count="77">
        ...
        <Instruction index="36" kind="I_OPER" assem="mov `d0, `s0">
            <Dst>
        ...
        <Instruction index="37" kind="I_LABEL" assem="L102:">
        ...
        <Instruction index="41" kind="I_LABEL" assem="L104:">
            <Label num="104" name="L104"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="42" kind="I_OPER" assem="movw `d0, #10">
            <Dst>
        ...
        <Instruction index="45" kind="I_OPER" assem="movw `d0, #2">
            <Dst>
        ...
        <Instruction index="51" kind="I_LABEL" assem="L103:">

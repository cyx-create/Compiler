<ScheduleProgram program_last_label_num="133" program_last_temp_num="16300" function_count="2">
    <Function index="0" name="b1^bubbleSort" last_label_num="133" last_temp_num="174" instruction_count="167">
    ...
    <Function index="1" name="__$main__^main" last_label_num="108" last_temp_num="156" instruction_count="85">
        ...
        <Instruction index="49" kind="I_OPER" assem="movw `d0, #10">
            <Dst>
        ...
        <Instruction index="52" kind="I_OPER" assem="movw `d0, #0">
            <Dst>

<ScheduleProgram program_last_label_num="110" program_last_temp_num="11000" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="110" last_temp_num="122" instruction_count="48">
        ...
        <Instruction index="10" kind="I_OPER" assem="mov `d0, #4">
            <Dst>
        ...
        <Instruction index="11" kind="I_OPER" assem="mov `d0, `s0">
            <Dst>
        ...
        <Instruction index="12" kind="I_LABEL" assem="L109:">
        ...
        <Instruction index="15" kind="I_OPER" assem="movw `d0, #10">
            <Dst>
        ...
        <Instruction index="24" kind="I_OPER" assem="mov `d0, #10">
            <Dst>
        ...
        <Instruction index="29" kind="I_OPER" assem="movw `d0, #0">
            <Dst>
        ...
        <Instruction index="36" kind="I_OPER" assem="movw `d0, #3">
            <Dst>
        ...
        <Instruction index="42" kind="I_OPER" assem="movw `d0, #32">
            <Dst>

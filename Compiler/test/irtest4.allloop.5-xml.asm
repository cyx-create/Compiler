<ScheduleProgram program_last_label_num="100112" program_last_temp_num="10003" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="108" last_temp_num="105" instruction_count="38">
        ...
        <Instruction index="13" kind="I_LABEL" assem="L100110:">
        ...
        <Instruction index="16" kind="I_OPER" assem="beq `j0">
            <Dst/>
            <Src/>
            <Jumps>
        ...
        <Instruction index="17" kind="I_LABEL" assem="L107:">
        ...
        <Instruction index="19" kind="I_LABEL" assem="L100111:">
        ...
        <Instruction index="25" kind="I_LABEL" assem="L106:">
            <Label num="106" name="L106"/>
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        <Instruction index="26" kind="I_LABEL" assem="L100112:">
        ...
        <Instruction index="29" kind="I_OPER" assem="movw `d0, #10">
            <Dst>
        ...
        <Instruction index="32" kind="I_OPER" assem="sub `d0, `s0, #1">
            <Dst>
                <Temp index="0" num="10003" name="t10003"/>
            </Dst>
            <Src>
        ...
        <Instruction index="35" kind="I_LABEL" assem="L100109:">
        ...
        <Instruction index="37" kind="I_OPER" assem="b `j0">
            ...
            <Src/>
            <Jumps>
                <Label index="0" num="100112" name="L100112"/>
            </Jumps>
        </Instruction>
    </Function>
</ScheduleProgram>

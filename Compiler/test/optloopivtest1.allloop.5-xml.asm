<ScheduleProgram program_last_label_num="105" program_last_temp_num="10305" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="105" last_temp_num="114" instruction_count="34">
        ...
        <Instruction index="7" kind="I_OPER" assem="movw `d0, #4">
            <Dst>
        ...
        <Instruction index="12" kind="I_OPER" assem="movw `d0, #65534">
            <Dst>
        ...
        <Instruction index="16" kind="I_OPER" assem="movw `d0, #10">
            <Dst>
        ...
        <Instruction index="31" kind="I_OPER" assem="sub `d0, `s0, #4">
            <Dst>

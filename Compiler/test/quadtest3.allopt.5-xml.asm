<ScheduleProgram program_last_label_num="100" program_last_temp_num="109" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="100" last_temp_num="108" instruction_count="16">
        ...
        <Instruction index="4" kind="I_OPER" assem="movw `d0, #1">
            <Dst>

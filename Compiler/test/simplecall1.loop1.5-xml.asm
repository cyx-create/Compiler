<ScheduleProgram program_last_label_num="100" program_last_temp_num="10500" function_count="2">
    <Function index="0" name="__$main__^main" last_label_num="100" last_temp_num="113" instruction_count="28">
        ...
        <Instruction index="13" kind="I_OPER" assem="mov r12, `s0">
            <Dst/>
            <Src>
                <Temp index="0" num="10400" name="t10400"/>
            </Src>
        ...
        <Instruction index="15" kind="I_OPER" assem="blx r12">
            <Dst/>
            <Src/>
            <Jumps/>
        </Instruction>
        ...
        <Instruction index="19" kind="I_OPER" assem="movw `d0, #10">
            <Dst>
    ...
    <Function index="1" name="C^m" last_label_num="100" last_temp_num="102" instruction_count="11">
        <Instruction index="0" kind="I_LABEL" assem="L100:">
            <Label num="100" name="L100"/>
            <Dst/>
            <Src/>

<ScheduleProgram program_last_label_num="113" program_last_temp_num="16600" function_count="2">
    <Function index="0" name="__$main__^main" last_label_num="113" last_temp_num="201" instruction_count="136">
        ...
        <Instruction index="88" kind="I_OPER" assem="mov `d0, r0">
            <Dst>
        ...
        <Instruction index="93" kind="I_OPER" assem="movw `d0, #47">
            <Dst>
        ...
        <Instruction index="129" kind="I_OPER" assem="movw `d0, #1">
            <Dst>

<ScheduleProgram program_last_label_num="110" program_last_temp_num="10200" function_count="1">
    <Function index="0" name="__$main__^main" last_label_num="110" last_temp_num="119" instruction_count="48">
        ...
        <Instruction index="9" kind="I_OPER" assem="movw `d0, #3">
            <Dst>
        ...
        <Instruction index="21" kind="I_OPER" assem="movw `d0, #10">
            <Dst>
